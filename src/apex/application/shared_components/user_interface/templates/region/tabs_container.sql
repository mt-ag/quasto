...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17114039339373944)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17114379130373944)
,p_plug_template_id=>wwv_flow_imp.id(17114039339373944)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17114643356373944)
,p_plug_template_id=>wwv_flow_imp.id(17114039339373944)
,p_name=>'Tabs'
