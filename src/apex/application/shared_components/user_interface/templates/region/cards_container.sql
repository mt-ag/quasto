...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17064386226373923)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17064652899373923)
,p_plug_template_id=>wwv_flow_imp.id(17064386226373923)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17064945336373924)
,p_plug_template_id=>wwv_flow_imp.id(17064386226373923)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17065267272373924)
,p_plug_template_id=>wwv_flow_imp.id(17064386226373923)
,p_name=>'Sub Regions'
