...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17099254299373938)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17099554714373939)
,p_plug_template_id=>wwv_flow_imp.id(17099254299373938)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17099889563373939)
,p_plug_template_id=>wwv_flow_imp.id(17099254299373938)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17100116075373939)
,p_plug_template_id=>wwv_flow_imp.id(17099254299373938)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17100412612373939)
,p_plug_template_id=>wwv_flow_imp.id(17099254299373938)
,p_name=>'Sub Regions'
