...
(
  ...
  qaif_created_on DATE default sysdate,
  qaif_created_by VARCHAR2(255 CHAR) default user,
  qaif_updated_on DATE default sysdate,
  qaif_updated_by VARCHAR2(255) default user
)';
